    ...
    <div class="main row" >
        ...
        <div id="FormMain" style="width:30%; margin-left:400px;">
			...
			<div id="ContainDiv" class="contact-form">
                <table>
                <tr>
                    <td><asp:TextBox ID="eId" runat="server" class="reg" placeholder="Enter Email Address"></asp:TextBox></td>
                    <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" ControlToValidate="eId" ErrorMessage="Please Enter Email Address">*</asp:RequiredFieldValidator>

                </td>    
                <td><asp:RegularExpressionValidator ID="regexEmailValid" runat="server" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="eId" ForeColor="Red" ErrorMessage="Please Enter Valid Email Address">*</asp:RegularExpressionValidator></td>
                </tr>

                </table>
                
                    <label class="fa-btn btn-1 btn-1e" style="margin-left:28%;">
                <asp:Button  ID="loginBtn" runat="server" Text="Submit" onclick="Button1_Click" /></label> 
                    
                    
			</div>
            <div id="errorDiv" style="font-size:large; margin-left:30px; color:Red;">
