		 ...
		 <ul>
			  ...
			  <li><a href="Message.aspx">Directores Message</a>
				<ul>
				  ...
				  <li><a href="inspmsg.aspx">Inspiration Message</a></li>
				</ul>
			  </li>
	...
	<div class="container">
		<div class="main row">
			...
			<div class="col-md-6 content_right">
				<h4>WHERE  THERE IS A </span> WILL THERE IS WAY.</h4>
				<p class="para">Driven by the philosophy that every individual is born to succeed, Chanakya IAS Academy’s direction as an organization is led by its founder Managing Director Mr. AK Mishra fondly known as Success guru.Liberty Career Academy was started in the year 1992 thousands of young people have shaped their careers with us and have created countless success stories in industry and still the journey goes on. We assure you of great learning experience and our continuous support with your career thereafter. With wide range of courses Liberty helps student to shape there career in variety of fields. </p>
				...
				<!----start-img-cursual---->
					<div id="owl-demo" class="owl-carousel text-center">
						...
						<div class="item">
							<div class="cau_left">
								<img class="lazyOwl" data-src="images/ib1.jpg" alt="Lazy Owl Image">
							</div>
							<div class="cau_left">
								<h4><a href="#">IBPS</a></h4>
								<p>
